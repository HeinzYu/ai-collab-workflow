...
| v1.7 | 2026-06-29 | **Bug 修复**：Full / Small / MVP 模式补充交互式模型对话 — 从 0 开始的新项目也会先运行模型对话，再执行文件生成 |
| v1.8 | 2026-06-29 | **边界补全**：初始化后配置复用策略（后续任务不重复对话）；7 种边界情况降级处理（用户不理/随便填/只填一个/手工改配置等）
